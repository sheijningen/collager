/* Pure selection-click logic for the file panel / collage tiles. Loaded as a
 * plain script in the renderer (window.CollagerSelection) and require()-able
 * from Node for unit tests. No DOM access in here. */
(function (exports) {
  'use strict';
   ...
   */
  function clickSelection({ selected, anchor, hash, ctrl, shift, order }) {
  ...
  exports.clickSelection = clickSelection;
})(
  typeof module !== 'undefined' && module.exports ? module.exports : (window.CollagerSelection = {})
);
